...
public class DiaryListResponseDto {
	...
	@NotNull
	private TotalGoalDetailResponseDto ThisMonthGoalInfo; // 전체 목표(todayMonth)

	@NotNull
	private List<GoalByCategoryDetailResponseDto> ThisMonthGoalByCategoryList; // 카테고리별 목표(todayMonth)

	@NotNull
	private TotalGoalDetailResponseDto totalGoal; // 전체 목표(todayMonth)

	@NotNull
	private List<GoalByCategoryDetailResponseDto> goalByCategoryList; // 카테고리별 목표(todayMonth)
	...
	public DiaryListResponseDto(List<DiaryCalendarResponseDto> diaryList,
		TotalGoalDetailResponseDto ThisMonthGoalInfo, List<GoalByCategoryDetailResponseDto> ThisMonthGoalByCategoryList,
		...
		this.ThisMonthGoalInfo = ThisMonthGoalInfo;
		this.ThisMonthGoalByCategoryList = ThisMonthGoalByCategoryList;
